...
function SplitPaymentOneModal({  splitPaymentModalOne, setSplitPaymentModalOne, setPaymentMethodOne , setPaymentOne }) {
        ...
        <View className="flex-1 items-center justify-center ">
           ...
           rounded-lg py-4 justify-center border duration-500`}>
                        ...
                        <View className=" px-5">
                            <TouchableOpacity
                                onPress={() => {
                                    setPaymentMethodOne("UPI");
                                    setSplitPaymentModalOne(false);
                                }}
                        ...
                        <View className="flex-row gap-3 justify-center mt-4 px-5">
                            <TouchableOpacity
                                ...
                                onPress={() => setSplitPaymentModalOne(false)}
                            >
...
export default SplitPaymentOneModal;
